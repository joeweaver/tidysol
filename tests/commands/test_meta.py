...
class TestMeta(TestCase):
    ...
    def test_single_timestep_with_descriptions(self):
        ...
        output = popen(['tidysol', 'meta', 'tests\\commands\\data\\good-single-timestep.txt','--values'], stdout=PIPE).communicate()[0].decode("utf-8")
    ...
    def test_single_timestep(self):
        ...
        output = popen(['tidysol', 'meta', 'tests\\commands\\data\\good-single-timestep.txt'], stdout=PIPE).communicate()[0].decode("utf-8")
